...
class VideoDataset(Dataset):
    ...
    def __init__(self, dataset='ucf101', split='train', clip_len=16, preprocess=False, output_dir='f2'):
        ...
        self.resize_height = 112#128#1080#128
        self.resize_width = 112#171#1920#171
        self.crop_size = 112
        ...
        for label in sorted(os.listdir(folder)):
            #print(os.listdir(os.path.join(folder, label)))
    ...
    def __getitem__(self, index):
        ...
        #print(f"Buffer shape: {buffer.shape}, Clip length: {self.clip_len}")
    ...
    def check_preprocess(self):
        ...
        for ii, video_class in enumerate(os.listdir(os.path.join(self.output_dir, 'train'))):
            print('train:',os.listdir(os.path.join(self.output_dir, 'train', video_class)))
            for video in os.listdir(os.path.join(self.output_dir, 'train', video_class)):
                print('path:',os.path.join(self.output_dir, 'train', video_class, video))
                video_name = os.path.join(os.path.join(self.output_dir, 'train', video_class, video),os.path.join(self.output_dir, 'train', video_class, video))+'.mp4'
    ...
    def process_video(self, video, action_name, save_dir):
        ...
        print('video:',os.path.join(save_dir, video_filename))
    ...
    def crop(self, buffer, clip_len, crop_size):
        ...
        #print('buffer.shape[0]:',buffer.shape[0] ,'clip_le:',clip_len)
    ...
    def compute_class_weights(self):
        ...
        print(np.unique(self.label_array))
        print(pd.value_counts(self.label_array))
